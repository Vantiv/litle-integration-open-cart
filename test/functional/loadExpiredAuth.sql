...
{address_2}
{city}, {zone} {postcode}
{country}','Flat Shipping Rate','flat.flat','',105.0000,1,0,0.0000,1,2,'USD',1.00000000,'127.0.0.1','','Mozilla/5.0 (X11; Linux i686 on x86_64; rv:11.0) Gecko/20100101 Firefox/11.0','en-us,en;q=0.5',{ts '2013-06-26 14:47:33'},{ts '2013-07-09 16:11:49'});
...
LitleAuthTxn:  
 Litle Response Code: 000
  Litle Transaction ID: 819799086987265306 
AVS Response: 20 - Neither zip nor address match
Card Validation Response: N - No Match
AuthCode: 111111',{ts '2013-07-03 14:46:48'});
