...
1) To begin you mmust donwload and install v. 1.5.3.1 of Opencart. Follow the directions and find the download on the http://www.opencart.com).

2) Install VQMOD-2.1.5-opencart. Follow the directions and find the download at  http://code.google.com/p/vqmod/. Make sure that all files in VQMOD are read/writeable or the installation will cause opencart to fail.
